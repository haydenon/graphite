...
Target "Bundle" (fun _ ->
  let serverDir = deployDir </> "Graphite.Server"
  let clientDir = deployDir </> "Graphite.Client"
  ...
  !! "src/Graphite.Client/public/**/*.*" |> CopyFiles publicDir
  !! "src/Graphite.Client/Images/**/*.*" |> CopyFiles imageDir

  !! "src/Graphite.Client/index.html"
  ++ "src/Graphite.Client/*.css"
  |> CopyFiles clientDir 
)
